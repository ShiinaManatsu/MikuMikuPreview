...
namespace MaterialUI
{
	...
	public class DialogPrompt : MaterialDialog
    {
		...
		{
			bool isButtonInteractable = !string.IsNullOrEmpty(m_FirstInputField.inputField.text);
			if (m_SecondInputField.gameObject.activeSelf)
			{
				isButtonInteractable &= !string.IsNullOrEmpty(m_SecondInputField.inputField.text);
			}
